...
text.  Jump down to line 841 where the draw_label method lives and we changed
...
the "draw_recticle" method starting on line 861:
...
be  red change line 865 to be "glColor3d(255, 0, 0)". How about if you want a
totally green reticle?  Then change line 865 to be "glColor3d(0, 255, 0)".  By
...
the reticle simply change line 777 from "n = 10" to "n = 20" that will double
